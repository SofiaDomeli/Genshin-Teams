...
characters = {
    ...
    'Sangonomiya Kokomi': 'https://i2.wp.com/genshinbuilds.aipurrjects.com/genshin/characters/sangonomiya_kokomi/image.png?strip=all&quality=100&w=160',
...
def index():
    ...
    if request.method == 'POST':
        ...
        character2 = request.form.get('character1')
        character3 = request.form.get('character2')

        returned_characters = [character, character2, character3]
...
def get_teams():
    teams = [['Lisa', 'Jean', 'Mona', 'Diluc'], ['Yae Miko', 'Zhongli', 'Yelan', 'Yaoyao'], ['Thoma', 'Venti', 'Xiao', 'Yelan']]
